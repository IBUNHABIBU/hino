class OurservicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ourservice.save
        format.html { redirect_to nyaki_path, notice: "Ourservice was successfully created." }
  ...
  def update
    respond_to do |format|
      if @ourservice.update(ourservice_params)
        format.html { redirect_to nyaki_path, notice: "This section was successfully updated." }
